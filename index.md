...
See also: <a href="{{ '/seeds/' | relative_url }}">Seeds</a> · <a href="{{ '/personal/' | relative_url }}">Personal Divagations</a> · <a href="{{ '/cv/' | relative_url }}">CV</a><!-- hidden: · <a href="{{ '/nulla-dies/' | relative_url }}">Nulla Dies</a> -->

<h2 style="margin-bottom: 0.8em;">Posts</h2>

<div class="posts-list">
<ul>
{% for post in site.posts %}{% unless post.tags contains "seed" or post.tags contains "nulla-dies" or post.tags contains "personal" %}
<li class="post-item">
