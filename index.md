...
See also: <a href="{{ '/seeds/' | relative_url }}">Seeds</a> · <a href="{{ '/shortform/' | relative_url }}">Shortform</a> · <a href="{{ '/personal/' | relative_url }}">Personal Divagations</a><!-- hidden: · <a href="{{ '/nulla-dies/' | relative_url }}">Nulla Dies</a> -->
