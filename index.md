...
See also: <a href="{{ '/seeds/' | relative_url }}">Seeds</a> · <a href="{{ '/widgets/' | relative_url }}">Widgets</a> · <a href="{{ '/personal/' | relative_url }}">Personal Divagations</a> · <a href="{{ '/cv/' | relative_url }}">CV</a><!-- hidden: · <a href="{{ '/nulla-dies/' | relative_url }}">Nulla Dies</a> -->
