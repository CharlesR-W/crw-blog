...
For Claude instances ghostwriting blog posts. This file should be iteratively updated — when CRW corrects your writing, add the correction here.
...
**Openings**: Start with the core claim or problem. Don't throat-clear. A 1-3 sentence abstract or setup, then dive in. "In this post I argue X" is acceptable if brief. Long preambles about the history of the field are not.

**Sections**: Relatively short. Each section has one job. Use ### liberally. Section titles can be playful: "Sleight-of-Hand", "Exordium: Who asked?", "Why Time Travel, FTL, Etc. Are All Possible".
...
**Pedagogical** (e.g. "Every Measurement Has a Scale"): Friendly, patient, uses extended worked examples, directly addresses the reader, ends with exercises. Still conversational but less profane.
...
All posts ghostwritten with Claude must include a signature, e.g.:
- "Written with Claude." or "Revised with Claude." at the bottom
- Style appropriate to the post's formality level
